        ...
        <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
            <div className="md:max-w-md lg:col-span-2">
              ...
              >
                <div className="img-icon"><img src="https://i.ibb.co/tQt2vL9/240-F-248279748-Re9qnj7-RFjtf2lb-LVqnr5-SAQ7h-WGx3-DE-removebg-preview.png" alt="" /></div>
              ...
              <div className="mt-4 lg:max-w-sm">
                <p className="text-sm text-white">
                  Beautiful Great Toy My name Is Bimol Sarker. I read Cse in
                  Habhit Tangail. This BABY TOY site is created by own.
                </p>
